    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ⚔️', url=f"https://t.me/adgmovieupdates") ] ] ),
            )
        return
    ...
    if not files_:
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                protect_content=True if pre == 'filep' else False,
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ⚔️', url="https://t.me/adgmovieupdates") ] ] ),
            )
            filetype = msg.media
